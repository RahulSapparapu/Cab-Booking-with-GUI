...
import iiitb.ess201a7.r16036.Fleet16036;
import iiitb.ess201a7.r16062.Fleet16062;
import iiitb.ess201a7.r16006.Fleet16006;
import iiitb.ess201a7.r16123.Fleet16123;
...
public class Demo {
	...
	public static void main(String[] args) {
		...
		{
			Fleet f1 = new Fleet16036("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);

			 f1 = new Fleet16006("blue"); // note: colour currently not used by Display
			 pf.addFleet(f1);
			 fleets.add(f1);

			 f1 = new Fleet16062("blue"); // note: colour currently not used by Display
			 pf.addFleet(f1);
			 fleets.add(f1);
